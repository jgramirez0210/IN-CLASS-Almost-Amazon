...
const domEvents = () => {
  document.querySelector('#main-container').addEventListener('click', (e) => {
    ...
    if (e.target.id.includes('submit-author')) {
      ...
      console.war('First name element:', firstNameElement);
      console.war('First name value:', firstNameElement.value);
      console.war('Last name element:', lastNameElement);
      console.war('Last name value:', lastNameElement.value);
