...
const domEvents = () => {
  document.querySelector('#main-container').addEventListener('click', (e) => {
    ...
    if (e.target.id.includes('submit-author')) {
      ...
      console.warn('First name element:', firstNameElement);
      console.warn('First name value:', firstNameElement.value);
      console.warn('Last name element:', lastNameElement);
      console.warn('Last name value:', lastNameElement.value);
